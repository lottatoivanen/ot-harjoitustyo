...
- Käyttäjä näkee listan kaikista projekteista.
- Lisätty ProjectService-luokka, joka vastaa projektien hallinan logiikasta.
- Testattu ProjectService-luokka ja että se palauttaa projektit oikein.
- Lisätty .coveragerc-tiedosto ja testikattavuusraportin generointi mahdollisuus.
...
## Viikko 6
- Käyttäjä pystyy lisäämään projektiin tärkeitä päivämääriä (harjoitus, esitys tai muu).
